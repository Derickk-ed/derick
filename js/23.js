...
function all_h3_click () {
	...
	h3_content.innerHTML = "You click one of the h3 element";
}

function h2_click(){
	var h2_content = document.getElementById("h2_content");
	h2_content.innerHTML = "<h1>You click h2 !!!</h1>";
}

function print_conversion (usd, vnd ){
	var html_message = document.getElementById("message");
	html_message.textContent = "You enter: "+ usd + " USD, this is convertd to VND: " + vnd + "k";	
}
